...
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports { usb_rxf_n }];
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { usb_txe_n }];
...
# ONBOARD LED
set_property -dict { PACKAGE_PIN D1   IOSTANDARD LVCMOS33 } [get_ports { led }];
