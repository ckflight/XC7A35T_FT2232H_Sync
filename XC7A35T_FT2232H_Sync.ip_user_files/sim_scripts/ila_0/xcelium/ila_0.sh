...
#
# Script generated by Vivado on Fri May 01 13:16:10 +03 2026
...
#
# Usage        : ila_0.sh
#                ila_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_0.sh [-rerun]
#                ila_0.sh [-reset_run]
#                ila_0.sh [-clean]
#                ila_0.sh [-reset_log]
...
#                script (type 'ila_0.sh -help' for more information).
#
...
# script info
echo -e "ila_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"../../../../XC7A35T_FT2232H_Sync.gen/sources_1/ip/ila_0/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ila_0.sh [-rerun]\n\
Usage: ila_0.sh [-reset_run]\n\
Usage: ila_0.sh [-clean]\n\
Usage: ila_0.sh [-reset_log]\n\
Usage: ila_0.sh [-keep_index]\n\
