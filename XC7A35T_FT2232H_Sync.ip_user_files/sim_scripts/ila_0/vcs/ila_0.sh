...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" +incdir+"../../../../XC7A35T_FT2232H_Sync.gen/sources_1/ip/ila_0/hdl/verilog" \
...
reset_run()
{
  files_to_remove=(ucli.key ila_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_0_simv.daidir vcs_lib c.obj)
