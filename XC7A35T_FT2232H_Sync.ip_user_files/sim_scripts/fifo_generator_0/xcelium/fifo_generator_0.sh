...
#
# Script generated by Vivado on Fri May 01 12:27:40 +03 2026
...
#                fifo_generator_0.sh [-rerun]
#                fifo_generator_0.sh [-reset_run]
#                fifo_generator_0.sh [-clean]
...
design_libs_elab="-libname xpm -libname fifo_generator_v13_2_14 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm fifo_generator_v13_2_14 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fifo_generator_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work fifo_generator_v13_2_14 $xmvlog_opts +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../../../tools/2025.2/data/rsb/busdef" \
...
Usage: fifo_generator_0.sh [-rerun]\n\
Usage: fifo_generator_0.sh [-reset_run]\n\
Usage: fifo_generator_0.sh [-clean]\n\
